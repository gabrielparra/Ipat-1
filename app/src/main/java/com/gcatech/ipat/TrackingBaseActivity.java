...
public class TrackingBaseActivity extends FragmentActivity implements SurfaceTextureListener {
    ...
    private void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(TrackingBaseActivity.this, msg, Toast.LENGTH_SHORT).show();
