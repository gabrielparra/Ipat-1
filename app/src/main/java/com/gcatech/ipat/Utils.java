...
public class Utils {
    ...
    public static void setResultToToastShort(final Context context, final String string) {
    ...
    public static void setTextProgressDialog(final Context ctx, final ProgressDialog progress, final String text) {
